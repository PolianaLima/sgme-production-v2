...
import updateReceita from "@/actions/receitas/update-receita";
...
export default function UpdateReceitaForm({receita}:Props){
    const [state, action] = useFormState(updateReceita,{
        ok: false,
        error: '',
        data: receita
    });
    ...
    console.log("Receita no form update",receita)
